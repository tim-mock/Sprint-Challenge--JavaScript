...
zooAnimals.forEach(animal => {
        ...
        */
        ...
        const lowCaseAnimalNames = zooAnimal.map(animal => {
                ...
                */
                const lowPopulationAnimals = zooAnimals.filter(animal => animal.population < 5); console.log(lowPopulationAnimals);
